...
`,
    ...
    for (const [path, content] of Object.entries(fileMap)) {
      ...
      // Skip platform config files generated by the AI by mistake to avoid duplicates in src/
      if (/^(package\.json|index\.html|index\.jsx?|vite\.config\.js)$/i.test(cleanPath) || cleanPath.startsWith("public/")) {
        continue;
      }
